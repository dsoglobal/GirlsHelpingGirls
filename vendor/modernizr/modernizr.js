/*!
 * modernizr v3.3.1
 * Build http://modernizr.com/download?-apng-appearance-backdropfilter-backgroundblendmode-backgroundcliptext-backgroundsize-bgpositionshorthand-bgpositionxy-bgrepeatspace_bgrepeatround-bgsizecover-borderimage-borderradius-boxshadow-boxsizing-capture-checked-cookies-cors-cssall-cssanimations-csscalc-csschunit-csscolumns-cssescape-cssexunit-cssfilters-cssgradients-csshairline-csshyphens_softhyphens_softhyphensfind-cssinvalid-cssmask-csspointerevents-csspositionsticky-csspseudoanimations-csspseudotransitions-cssreflections-cssremunit-cssresize-cssscrollbar-csstransforms-csstransforms3d-csstransitions-cssvalid-cssvhunit-cssvmaxunit-cssvminunit-cssvwunit-cubicbezierrange-devicemotion_deviceorientation-directory-display_runin-displaytable-ellipsis-emoji-eventlistener-fileinput-flash-flexbox-flexboxlegacy-flexboxtweener-flexwrap-fontface-formattribute-formvalidation-generatedcontent-geolocation-hashchange-hiddenscroll-history-hsla-ie8compat-inlinesvg-input-inputformaction-inputformenctype-inputformmethod-inputformtarget-inputtypes-jpeg2000-jpeg2000-jpegxr-json-lastchild-localizednumber-mediaqueries-multiplebgs-nthchild-objectfit-oninput-opacity-overflowscrolling-placeholder-pointerevents-preserve3d-regions-requestautocomplete-rgba-sandbox-seamless-search-shapes-siblinggeneral-sizes-smil-srcdoc-srcset-subpixelfont-supports-svg-svgasimg-svgclippaths-svgfilters-svgforeignobject-target-textalignlast-textshadow-touchevents-unicode-unicoderange-userselect-video-videoautoplay-videoloop-videopreload-webp-webpalpha-webpanimation-webplossless_webp_lossless-willchange-wrapflow-addtest-atrule-domprefixes-hasevent-load-mq-prefixed-prefixedcss-prefixes-printshiv-setclasses-testallprops-testprop-teststyles-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
